...
public class PIIS405ErrorMapperTest {
    private static final String ERROR_JSON_PATH = "json/service/mapper/psd2/piis/Error405NGPIIS.json";
    ...
    @InjectMocks
    private PIIS405ErrorMapper piis405ErrorMapper;
    ...
    public void getMapper_shouldReturnCorrectErrorMapper() {
        ...
        // Given
        Error405NGPIIS expectedError = jsonReader.getObjectFromFile(ERROR_JSON_PATH, Error405NGPIIS.class);

        // When
        Function<MessageError, Error405NGPIIS> mapper = piis405ErrorMapper.getMapper();
        Error405NGPIIS actualError = mapper.apply(MESSAGE_ERROR);
    ...
    public void getMapper_withNoTextInTppMessage_shouldGetTextFromMessageService() {
        ...
        // Given
        Error405NGPIIS expectedError = jsonReader.getObjectFromFile(ERROR_CUSTOM_TEXT_JSON_PATH, Error405NGPIIS.class);

        // When
        Function<MessageError, Error405NGPIIS> mapper = piis405ErrorMapper.getMapper();
        Error405NGPIIS actualError = mapper.apply(MESSAGE_ERROR_WITHOUT_TEXT);
