...
import static de.adorsys.psd2.xs2a.core.error.MessageErrorCode.SERVICE_INVALID_406;
...
public class PIS406ErrorMapperTest {
    ...
    public void getMapper_shouldReturnCorrectErrorMapper() {
        when(messageService.getMessage(SERVICE_INVALID_406.name()))
            .thenReturn("Some %s");
    ...
    public void getMapper_withNoTextInTppMessage_shouldGetTextFromMessageService() {
        ...
        // Then
        assertEquals(expectedError, actualError);
        verify(messageService).getMessage(SERVICE_INVALID_406.name());
    }
}
