...
public class PIIS401ErrorMapperTest {
    ...
    private static final MessageError MESSAGE_ERROR = new MessageError(ErrorType.PIIS_401,
                                                                       TppMessageInformation.of(CONSENT_INVALID));
    private static final MessageError MESSAGE_ERROR_WITHOUT_TEXT = new MessageError(ErrorType.PIIS_401,
                                                                                    TppMessageInformation.of(CONSENT_INVALID));
    ...
    public void getMapper_shouldReturnCorrectErrorMapper() {
        ...
        // When
        Function<MessageError, Error401NGPIIS> mapper = piis401ErrorMapper.getMapper();
        Error401NGPIIS actualError = mapper.apply(MESSAGE_ERROR);
    ...
    public void getMapper_withNoTextInTppMessage_shouldGetTextFromMessageService() {
        ...
        // Given
        Error401NGPIIS expectedError = jsonReader.getObjectFromFile(ERROR_CUSTOM_TEXT_JSON_PATH, Error401NGPIIS.class);

        // When
        Function<MessageError, Error401NGPIIS> mapper = piis401ErrorMapper.getMapper();
        Error401NGPIIS actualError = mapper.apply(MESSAGE_ERROR_WITHOUT_TEXT);
