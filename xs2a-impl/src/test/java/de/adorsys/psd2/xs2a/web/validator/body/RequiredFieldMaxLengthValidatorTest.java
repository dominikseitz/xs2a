...
public class RequiredFieldMaxLengthValidatorTest {
    ...
    public void init() {
        ...
        requiredFieldMaxLengthValidator = new RequiredFieldMaxLengthValidator(stringMaxLengthValidator, errorBuildingService);
    }
    ...
    public void validate_success() {
        ...
        //When
        requiredFieldMaxLengthValidator.validate(panField, messageError);
    ...
    public void validate_long_field_name() {
        ...
        assertArrayEquals(new String[] {"PAN", "9"}, messageError.getTppMessage().getTextParameters());
    }
}
